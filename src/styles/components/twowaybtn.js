...
const CustomBtn = styled.button`
    ...
    &:hover {
        background-color: ${(props) => props.set === "white" ? theme.color.primary : theme.color.primary} !important;
        color : ${(props) => props.set === "white" ? theme.color.white : theme.color.white} !important;
